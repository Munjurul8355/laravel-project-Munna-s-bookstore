...
<div class="container mt-0">
    ...
    <a href="{{ route('books.create') }}" class="btn btn-info ms-3">New Book</a>
</div>
    <table class="table table-bordered table-striped">
        ...
        @forelse($books as $book)
            <tr>
                ...
                <td>{{ $book->price }}</td>
                <td>
    <a href="{{ route('books.show', $book->id) }}" class="btn btn-sm btn-outline-warning">Details</a>
<a href="{{ route('books.edit', $book->id) }}" class="btn btn-sm btn-outline-primary">Update</a>
